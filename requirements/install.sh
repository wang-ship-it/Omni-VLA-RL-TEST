...
SUPPORTED_MODELS=("openvla" "openvla-oft" "openpi" "omni_vla" "gr00t" "dexbotic")
SUPPORTED_ENVS=("behavior" "maniskill_libero" "metaworld" "calvin" "isaaclab" "robocasa" "franka" "frankasim" "robotwin" "habitat" "opensora" "wan" "minimal")
...
install_omni_vla_model() {
    case "$ENV_NAME" in
        ...
        minimal)
            ...
            ;;
        *)
            echo "Environment '$ENV_NAME' is not supported for Omni VLA model." >&2
            exit 1
            ;;
    esac
