...
class Qwen2VLRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen2VLConfig, device=None):
        ...
        # print('self.rope_type', self.rope_type)
...
def apply_multimodal_rotary_pos_emb(q, k, cos, sin, mrope_section, unsqueeze_dim=1):
    ...
    """
    # print('in apply pos emb beginning')
    # # cos = cos.squeeze(1)
    # # sin = sin.squeeze(1)

    # print('q', q.shape) #heads, seq_len, head_dim
    # # print('k', k.shape) #heads, seq_len, head_dim
    # print('cos', cos.shape)
    # print('sin', sin.shape)

    #     in apply pos emb beginning
    # q torch.Size([1, 12, 3602, 128])
    # k torch.Size([1, 2, 3602, 128])
    # cos torch.Size([3, 1, 3602, 128])
    # sin torch.Size([3, 1, 3602, 128])
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                ...
                image_embeds = self.visual(pixel_values, grid_thw=image_grid_thw) # 视觉特征提取
        ...
        if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
            ...
            if (
                ...
                # print('position_ids', position_ids.shape)
                # print(position_ids.squeeze(1)[0])
                # print(position_ids.squeeze(1)[1])
                # print(position_ids.squeeze(1)[2])
