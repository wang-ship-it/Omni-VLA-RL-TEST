...
from ..vlm_expert.qwen2vl.image_processing_qwen2_vl import Qwen2VLImageProcessor
...
class QwenVL2ImageTransform:
    def __init__(
        ...
        self.processor = Qwen2VLImageProcessor.from_pretrained('/home/user/robot/model/G2VLM-2B-MoT')
    ...
    def __call__(self, img):
        ...
        out = self.processor(img, return_tensors="pt", do_rescale=False)
        pixel_values =  out['pixel_values'] # this is flattened. 
        image_grid_thw =  out['image_grid_thw']
