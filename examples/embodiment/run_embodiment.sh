...
export OMNI_VLA_DEBUG_LOG=${OMNI_VLA_DEBUG_LOG:-0}
export OMNI_VLA_DEBUG_EVERY=${OMNI_VLA_DEBUG_EVERY:-1}
export OMNI_VLA_DEBUG_LOSS=${OMNI_VLA_DEBUG_LOSS:-$OMNI_VLA_DEBUG_LOG}
export OMNI_VLA_DEBUG_ADV=${OMNI_VLA_DEBUG_ADV:-$OMNI_VLA_DEBUG_LOG}
